...
// if_freq: -406250.0
// nb_filter: 4
// nb_filter_bw: 143.23833333333334
// wb_filter: 4
// wb_filter_bw: 143.23833333333334
...
#define RADIO_CONFIG_GPIO_PIN_CFG { \
  ...
  0x1A /* GPIO0,PULL_CTL[6],GPIO_MODE[5:0] */,\
  0x20 /* GPIO1,PULL_CTL[6],GPIO_MODE[5:0] */,\
  0x00 /* GPIO2,PULL_CTL[6],GPIO_MODE[5:0] */,\
  0x00 /* GPIO3,PULL_CTL[6],GPIO_MODE[5:0] */,\
...
#define RADIO_CONFIG_SET_PROPERTY_SYNTH_PFDCP_CPFF { \
  ...
  0x01 /* NUM_PROPS                                         */,\
  0x00 /* START_PROP                                        */,\
  0x34 /* SYNTH_PFDCP_CPFF,CP_FF_CUR_TEST[6],CP_FF_CUR[5:0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_SYNTH_LPFILT2 { \
  ...
  0x01 /* NUM_PROPS                    */,\
  0x04 /* START_PROP                   */,\
  0x07 /* SYNTH_LPFILT2,LPF_FF_C2[4:0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_SYNTH_LPFILT1 { \
  ...
  0x01 /* NUM_PROPS                                                       */,\
  0x05 /* START_PROP                                                      */,\
  0x70 /* SYNTH_LPFILT1,LPF_FF_C1[6:4],LPF_FF_C1_CODE[3:2],LPF_FF_C3[1:0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MODEM_DATA_RATE { \
  ...
  0x03 /* NUM_PROPS                                                    */,\
  0x03 /* START_PROP                                                   */,\
  0x0F /* MODEM_DATA_RATE,DATA_RATE[7:0],DATA_RATE[7:0],DATA_RATE[7:0] */,\
  0x42 /* DATA1                                                        */,\
  0x40 /* DATA2                                                        */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_PA_TC { \
  ...
  0x01 /* NUM_PROPS                      */,\
  0x03 /* START_PROP                     */,\
  0x5D /* PA_TC,FSK_MOD_DLY[7:5],TC[4:0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MODEM_MDM_CTRL { \
  ...
  0x01 /* NUM_PROPS                                    */,\
  0x19 /* START_PROP                                   */,\
  0x00 /* MODEM_MDM_CTRL,PH_SRC_SEL[7],FIFO_SRC_SEL[0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MODEM_BCR_NCO_OFFSET { \
  ...
  0x03 /* NUM_PROPS                                             */,\
  0x24 /* START_PROP                                            */,\
  0x07 /* MODEM_BCR_NCO_OFFSET,NCOFF[5:0],NCOFF[7:0],NCOFF[7:0] */,\
  0xE0 /* DATA1                                                 */,\
  0x7E /* DATA2                                                 */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MODEM_BCR_MISC1 { \
  ...
  0x01 /* NUM_PROPS                                                                                                  */,\
  0x2A /* START_PROP                                                                                                 */,\
  0x00 /* MODEM_BCR_MISC1,BCRFBBYP[7],SLICEFBBYP[6],RXNCOCOMP[4],RXCOMP_LAT[3],CRGAINX2[2],DIS_MIDPT[1],ESC_MIDPT[0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MODEM_AFC_GEAR { \
  ...
  0x01 /* NUM_PROPS                                               */,\
  0x2C /* START_PROP                                              */,\
  0x00 /* MODEM_AFC_GEAR,GEAR_SW[7:6],AFC_FAST[5:3],AFC_SLOW[2:0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MODEM_AFC_GAIN { \
  ...
  0x02 /* NUM_PROPS                                                                  */,\
  0x2E /* START_PROP                                                                 */,\
  0x83 /* MODEM_AFC_GAIN,ENAFC[7],AFCBD[6],AFC_GAIN_DIV[5],AFCGAIN[4:0],AFCGAIN[7:0] */,\
  0xF0 /* DATA1                                                                      */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MODEM_AFC_MISC { \
  ...
  0x01 /* NUM_PROPS                                                                                                                  */,\
  0x32 /* START_PROP                                                                                                                 */,\
  0xE0 /* MODEM_AFC_MISC,ENAFCFRZ[7],ENFBPLL[6],EN2TB_EST[5],ENFZPMEND[4],ENAFC_CLKSW[3],OOK_ZEROG[2],NON_FRZEN[1],LARGE_FREQ_ERR[0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MODEM_AGC_RFPD_DECAY { \
  ...
  0x01 /* NUM_PROPS                            */,\
  0x39 /* START_PROP                           */,\
  0x0E /* MODEM_AGC_RFPD_DECAY,RFPD_DECAY[7:0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MODEM_AGC_IFPD_DECAY { \
  ...
  0x01 /* NUM_PROPS                            */,\
  0x3A /* START_PROP                           */,\
  0x0E /* MODEM_AGC_IFPD_DECAY,IFPD_DECAY[7:0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MODEM_FSK4_TH { \
  ...
  0x02 /* NUM_PROPS                             */,\
  0x3D /* START_PROP                            */,\
  0x19 /* MODEM_FSK4_TH,4FSKTH[7:0],4FSKTH[7:0] */,\
  0x9A /* DATA1                                 */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MODEM_OOK_PDTC { \
  ...
  0x01 /* NUM_PROPS                             */,\
  0x40 /* START_PROP                            */,\
  0x28 /* MODEM_OOK_PDTC,ATTACK[6:4],DECAY[3:0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MODEM_OOK_MISC { \
  ...
  0x01 /* NUM_PROPS                                                                                           */,\
  0x43 /* START_PROP                                                                                          */,\
  0x23 /* MODEM_OOK_MISC,OOKFASTMA[7],OOK_LIMIT_DISCHG[5],OOK_SQUELCH_EN[4],OOK_DISCHG_DIV[3:2],DETECTOR[1:0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MODEM_RAW_CONTROL { \
  ...
  0x01 /* NUM_PROPS                                                                */,\
  0x45 /* START_PROP                                                               */,\
  0x03 /* MODEM_RAW_CONTROL,UNSTDPK[7],CONSCHK_BYP[6],PM_PATTERN[3:2],RAWGAIN[1:0] */\
}
...
#define RADIO_CONFIG_SET_PROPERTY_MODEM_DSA_QUAL { \
  ...
  0x01 /* NUM_PROPS                                   */,\
  0x5D /* START_PROP                                  */,\
  0x06 /* MODEM_DSA_QUAL,EYE_QUAL_SEL[7],ARRQUAL[6:0] */\
}
